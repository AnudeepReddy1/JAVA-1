...
class CRUD
{
	...
	public static void displayMenu()
	{
		while(true)
		{
			...
			switch (takeChoiceFromUser("menu"))
			{
				case 1: create();
						break;
				case 2: read();
						break;
				case 3: search("select");
						break;
				case 4: update();
						break;
				case 5: delete();
	...
	public static void printDetails()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				if(rs.getString(columnNames.size()).equals("active"))
				{
					counter++;
					if (counter == 1)
					{
	...
	public static int search(String mode)
	{
		scan.nextLine();
	...
	public static void update()
	{
		if(search("update") == 1)
		{
			...
			int update_choice = takeChoiceFromUser("update");
	...
	public static void delete()
	{
		if(search("delete") == 1)
		{
			sql_query = "update " + table_name + " set " + columnNames.get(columnCount - 1) + " = 'inactive' where "+ columnNames.get(0) +" = '" + input_id + "'";
	...
	public static int takeChoiceFromUser(String mode)
	{
		try
		{
			choice = scan.nextInt();
